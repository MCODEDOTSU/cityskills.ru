        ...
        <div class="content">
            ...
            if (!empty($region) && !empty($city)) {
                $option['meta_query'] = [
                    ...
                    [
                        'key' => "project_office_city_$region",
                        'value' => $city
                    ]
                ];
            }
                        ...
                        <div class="post-item"><a href="<?=get_permalink(get_the_ID())?>" title="<?=get_the_title()?>">
                            ...
                            <?php if(get_post_field( 'project_office_region' ) && get_post_field( 'project_office_region' ) != 'all'): ?>
                                ...
                                <div class="project-office-city">
                                    <a href="/category/press-centr/novosti-proektnyx-ofisov?region=<?= $region ?>&city=<?=get_post_field( "project_office_city_$region" )?>" title="<?=get_post_field( "project_office_city_$region" )?>">
            ...
            <?php else: ?>
                <div class="message">К сожалению, новости за данный период времени не найдены</div>
            <?php
                endif;
                wp_reset_postdata();
            ?>
